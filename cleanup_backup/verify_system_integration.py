...
def check_control_scripts():
    ...
    scripts = [
        ('check_violations.py', 'Violation kontrol scripti'),
        ('monitor_violations.py', 'Canlı izleme scripti'),
        ('view_snapshots.py', 'Snapshot görüntüleyici'),
        ('migrate_add_resolution_snapshot.py', 'Migration scripti'),
        ('verify_system_integration.py', 'Sistem doğrulama scripti')
    ]
    ...
    print("\n💡 Kullanım:")
    print("   • python check_violations.py       - Genel kontrol")
    print("   • python monitor_violations.py     - Canlı izleme")
    print("   • python view_snapshots.py         - Snapshot'ları görüntüle")
